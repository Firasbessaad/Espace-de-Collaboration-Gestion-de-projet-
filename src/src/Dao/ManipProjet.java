...
public class ManipProjet {

	public static void nouveau_Fichier(String nomfichier, String idgroupe , String idprojet) throws IOException{
		...
		String path ="javascript/javascript.js";
		String mode = "";
		switch (langage) {
		case "js":
			...
			mode = "javascript";
			 break;
		case "html":
			path = "htmlembedded/htmlembedded.js";
			mode = "html";
			 break;
		case "java":
			path = "clike/clike.js";
	...
	public static void telecharger(String idgroupe) throws IOException{
		String lol = "/home/firas/workspace/Pcd2test/WebContent/Groupes/"+idgroupe;
		String[] b = {"gzip", lol};
