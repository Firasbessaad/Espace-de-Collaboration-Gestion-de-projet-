...
<script>function init() { var firepadRef = new Firebase('https://intense-fire-2283.firebaseio.com/compte/1/firas');var codeMirror = CodeMirror(document.getElementById('firepad-container'), {lineNumbers: true,mode: 'c'}); var firepad = Firepad.fromCodeMirror(firepadRef, codeMirror, { defaultText: 'Commencer votre code en c'});}/* Helper to get hash from end of URL or generate a random one. */function getExampleRef() {var ref = new Firebase('https://firepad.firebaseio-demo.com');var hash = window.location.hash.replace(/#/g, '');if (hash) {ref = ref.child(hash);} else {ref = ref.push(); window.location = window.location + '#' + ref.key(); }if (typeof console !== 'undefined')console.log('Firebase data: ', ref.toString());return ref;}init(); </script>
