! function(t, e) {
    ...
    function r(n, r, c) {
        ...
        function f() {
            oe = r.theme ? "ui" : "fc", n.addClass("fc"), n.addClass(r.isRTL ? "fc-rtl" : "fc-ltr"), r.theme && n.addClass("ui-widget"), ae = t("<div class='fc-content' style='position:relative'/>").prependTo(n), ne = new a(ee, r), re = ne.render(), re && n.prepend(re), y(r.defaultView), r.handleWindowResize && t(window).resize(x), m() || v()
        }
        ...
        function w(e) {
            he++, ie && (te("viewDestroy", ie, ie, ie.element), B(), ie.triggerEventDestroy(), G(), ie.element.remove(), ne.deactivateButton(ie.name)), ne.activateButton(e), ie = new me[e](t("<div class='fc-view block fc-view-" + e + "' style='position:relative'/>").appendTo(ae), ee), C(), $(), he--
        }

        function C(t) {
            (!ie.start || t || ge < ie.start || ge >= ie.end) && p() && M(t)
        }

        function M(t) {
            he++, ie.start && (te("viewDestroy", ie, ie, ie.element), B(), N()), G(), ie.render(ge, t || 0), S(), $(), (ie.afterRender || A)(), _(), Y(), te("viewRender", ie, ie, ie.element), ie.trigger("viewDisplay", de), he--, z()
        }
        ...
        function S() {
            le === e && E(), he++, ie.setHeight(le), ie.setWidth(ae.width()), he--, se = n.outerWidth()
        }
        ...
        function x() {
            if (!he)
                if (ie.start) {
                    var t = ++ve;
                    setTimeout(function() {
                        t == ve && !he && p() && se != (se = n.outerWidth()) && (he++, T(), ie.trigger("windowResize", de), he--)
                    }, 200)
                } else v()
        }
        ...
        function Y() {
            var t = new Date;
            t >= ie.start && t < ie.end ? ne.disableButton("today") : ne.enableButton("today")
        }
        ...
        function K(t, n) {
            return n === e ? r[t] : void(("height" == t || "contentHeight" == t || "aspectRatio" == t) && (r[t] = n, T()))
        }

        function te(t, e) {
            return r[t] ? r[t].apply(e || de, Array.prototype.slice.call(arguments, 2)) : void 0
        }
        var ee = this;
        ee.options = r, ee.render = u, ee.destroy = h, ee.refetchEvents = k, ee.reportEvents = O, ee.reportEventChange = L, ee.rerenderEvents = H, ee.changeView = y, ee.select = q, ee.unselect = B, ee.prev = P, ee.next = j, ee.prevYear = I, ee.nextYear = X, ee.today = J, ee.gotoDate = V, ee.incrementDate = U, ee.formatDate = function(t, e) {
            return b(t, e, r)
    ...
    function a(e, n) {
            ...
            return o && t.each(o.split(" "), function(r) {
                ...
                t.each(this.split(","), function(r, i) {
                    if ("title" == i) a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(d + "-corner-right"), o = null;
                        ...
                        var s;
                        if (e[i] ? s = e[i] : me[i] && (s = function() {
                                u.removeClass(d + "-state-hover"), e.changeView(i)
                            }), s) {
                            var l = n.theme ? Y(n.buttonIcons, i) : null,
                                c = Y(n.buttonText, i),
                                u = t("<span class='fc-button fc-button-" + i + " " + d + "-state-default'>" + (l ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + l + "'/></span>" : c) + "</span>").click(function() {
                            ...
                            B(u), o || u.addClass(d + "-corner-left"), o = u
                        }
                    }
        ...
        var f = this;
        f.render = r, f.destroy = a, f.updateTitle = i, f.activateButton = s, f.deactivateButton = l, f.disableButton = c, f.enableButton = u;
        var d, v = t([])
    }
    ...
    function o(n, r) {
            ...
            s(e, function(a) {
                if (r == R) {
                    if (a) {
                        ...
                        for (var o = 0; o < a.length; o++) a[o].source = e, b(a[o]);
                        W = W.concat(a)
                    }
                    N--, N || k(W)
                }
        ...
        function s(e, r) {
            var a, o, i = pe.sourceFetchers;
            for (a = 0; a < i.length; a++) {
                if (o = i[a](e, T, E, r), o === !0) return;
                if ("object" == typeof o) return void s(o, r)
            }
            var l = e.events;
            if (l) t.isFunction(l) ? (m(), l(d(T), d(E), function(t) {
                r(t), y()
            })) : t.isArray(l) ? r(l) : r();
            else {
                var c = e.url;
                if (c) {
                    ...
                    var g = t.extend({}, u || {}),
                        p = X(e.startParam, n.startParam),
                        b = X(e.endParam, n.endParam);
                    p && (g[p] = Math.round(+T / 1e3)), b && (g[b] = Math.round(+E / 1e3)), m(), t.ajax(t.extend({}, ye, e, {
                        data: g,
                        success: function(e) {
                            e = e || [];
                            var n = I(f, this, arguments);
                            t.isArray(n) && (e = n), r(e)
                        },
                        error: function() {
                            I(v, this, arguments), r()
                        },
                        complete: function() {
                            I(h, this, arguments), y()
                        }
                    }))
                } else r()
            }
        ...
        function h(e) {
            if (e) {
                ...
                W = t.grep(W, e, !0);
                for (var r = 0; r < F.length; r++) t.isArray(F[r].events) && (F[r].events = t.grep(F[r].events, e, !0))
            } else {
                W = [];
                for (var r = 0; r < F.length; r++) t.isArray(F[r].events) && (F[r].events = [])
            }
            k(W)
        }
        ...
        function D(t) {
            ...
            for (var e = pe.sourceNormalizers, n = 0; n < e.length; n++) e[n](t)
        }
        ...
        for (var T, E, S = M.trigger, x = M.getView, k = M.reportEvents, H = {
                events: []
            }, F = [H], R = 0, N = 0, z = 0, W = [], A = 0; A < r.length; A++) c(r[A])
    }
    ...
    function E(e, n, r) {
        for (var a, o = 0; o < e.length; o++) a = t(e[o]), a.width(Math.max(0, n - x(a, r)))
    }

    function S(e, n, r) {
        for (var a, o = 0; o < e.length; o++) a = t(e[o]), a.height(Math.max(0, n - R(a, r)))
    }
    ...
    function Z(e, n, r) {
        ...
        function s() {
            var n = c();
            L && L.remove(), L = t(n).appendTo(e), _ = L.find("thead"), Y = _.find(".fc-day-header"), j = L.find("tbody"), I = j.find("tr"), X = j.find(".fc-day"), J = I.find("td:first-child"), V = I.eq(0).find(".fc-day > div"), U = I.eq(0).find(".fc-day-content > div"), P(_.add(_.find("tr"))), P(I), I.eq(0).addClass("fc-first"), I.filter(":last").addClass("fc-last"), X.each(function(e, n) {
        ...
        function c() {
            var t = "<table class='fc-border-separate' cellspacing='0'>" + u() + v() + "</table>";
            return t
        }
        ...
        function u() {
            var t, e, n = he + "-widget-header",
                r = "";
            for (r += "<thead><tr>", pe && (r += "<th class='fc-week-number " + n + "'>" + q(me) + "</th>"), t = 0; ne > t; t++) e = Ee(0, t), r += "<th class='fc-day-header fc-" + De[e.getDay()] + " " + n + "'>" + q(ke(e, ge)) + "</th>";
            return r += "</tr></thead>"
        }
        ...
        function v() {
            ...
            for (a += "<tbody>", t = 0; ee > t; t++) {
                for (a += "<tr class='fc-week'>", pe && (n = Ee(t, 0), a += "<td class='fc-week-number " + r + "'><div>" + q(ke(n, ye)) + "</div></td>"), e = 0; ne > e; e++) n = Ee(t, e), a += h(n);
                a += "</tr>"
            }
            return a += "</tbody>"
        }
        ...
        function h(t) {
            ...
            return t.getMonth() != n && o.push("fc-other-month"), +t == +r ? o.push("fc-today", he + "-state-highlight") : o.push(r > t ? "fc-past" : "fc-future"), a += "<td class='" + o.join(" ") + "' data-date='" + ke(t, "yyyy-MM-dd") + "'><div>", re && (a += "<div class='fc-day-number'>" + t.getDate() + "</div>"), a += "<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>"
        }
        ...
        function p(t) {
            $ = t, se.clear(), de.clear(), te = 0, pe && (te = _.find("th.fc-week-number").outerWidth()), K = Math.floor(($ - te) / ne), E(Y.slice(0, -1), K)
        }

        function y(t) {
            t.click(b).mousedown(Te)
        }
        ...
        function D(t, e, n) {
            n && oe.build();
            for (var r = xe(t, e), a = 0; a < r.length; a++) {
                var o = r[a];
        ...
        var O = this;
        O.renderBasic = a, O.setHeight = g, O.setWidth = p, O.renderDayOverlay = D, O.defaultSelectionEnd = C, O.renderSelection = M, O.clearSelection = T, O.reportDayClick = S, O.dragStart = x, O.dragStop = k, O.defaultEventEnd = H, O.getHoverListener = function() {
            return ie
        ...
        var L, _, Y, j, I, X, J, V, U, Z, $, Q, K, te, ee, ne, re, oe, ie, se, de, he, ge, pe, me, ye, be = O.opt,
            we = O.trigger,
            Ce = O.renderOverlay,
            Me = O.clearOverlays,
            Te = O.daySelectionMousedown,
            Ee = O.cellToDate,
            Se = O.dateToCell,
    ...
    function K(n, r, a) {
        ...
        function g() {
            var t, e, n, r = Be + "-widget-header",
                a = "";
            for (a += "<thead><tr>", Je ? (e = sn(t, Ue), Pe ? e += Ve : e = Ve + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + q(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; Ae > n; n++) t = rn(0, n), a += "<th class='fc-" + De[t.getDay()] + " fc-col" + n + " " + r + "'>" + q(sn(t, Xe)) + "</th>";
        ...
        function p() {
            var t, e, n, r, a, o = Be + "-widget-header",
                ...
                s = f(new Date),
                l = "";
            for (l += "<tbody><tr><th class='fc-agenda-axis " + o + "'>&nbsp;</th>", n = "", e = 0; Ae > e; e++) t = rn(0, e), a = ["fc-col" + e, "fc-" + De[t.getDay()], i], +t == +s ? a.push(Be + "-state-highlight", "fc-today") : a.push(s > t ? "fc-past" : "fc-future"), r = "<td class='" + a.join(" ") + "'><div><div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>", n += r;
        ...
        function m(t) {
            ...
            he.height(a - R(de)), ge.css("top", n), be.height(a - r - 1), Re = Te.height() + 1, ze = Ze("slotMinutes") / Ne, We = Re / ze
        }

        function b(e) {
            Se = e, Ye.clear(), qe.clear();
            var n = ee.find("th:first");
            me && (n = n.add(me.find("th:first"))), n = n.add(Me.find("th:first")), ke = 0, E(n.width("").each(function(e, n) {
                ke = Math.max(ke, t(n).outerWidth())
            }), ke);
            var r = K.find(".fc-agenda-gutter");
            me && (r = r.add(me.find("th.fc-agenda-gutter")));
            var a = be[0].clientWidth;
            Fe = be.width() - a, Fe ? (E(r, Fe), r.show().prev().removeClass("fc-last")) : r.hide().prev().addClass("fc-last"), He = Math.floor((a - ke) / Ae), E(ne.slice(0, -1), He)
        }
        ...
        function C(t) {
            t.click(T).mousedown(en)
        }

        function M(t) {
            t.click(T).mousedown(U)
        }
        ...
        function x(t, e, n) {
            n && Le.build();
            for (var r = on(t, e), a = 0; a < r.length; a++) {
                var o = r[a];
        ...
        function _(t, n) {
            if (t = d(t, !0), n < u(d(t), je)) return 0;
                ...
                if (a >= 0 && Ae > a) {
                    ...
                    if (s > i) {
                        if (o.top = i, o.height = s - i, o.left += 2, o.width -= 5, t.isFunction(r)) {
                            var l = r(e, n);
                            l && (o.position = "absolute", Ee = t(l).css(o).appendTo(we))
                        } else o.isStart = !0, o.isEnd = !0, Ee = t(nn({
                            title: "",
                            start: e,
                            end: n,
                            className: ["fc-select-helper"],
                            editable: !1
                        }, o)), Ee.css("opacity", Ze("dragOpacity"));
                        Ee && (M(Ee), we.append(Ee), E(Ee, o.width, !0), S(Ee, o.height, !0))
                    }
                }
            } else H(e, n)
        }
        ...
        var Q = this;
        Q.renderAgenda = o, Q.setWidth = b, Q.setHeight = m, Q.afterRender = w, Q.defaultEventEnd = j, Q.timePosition = _, Q.getIsCellAllDay = A, Q.allDayRow = Y, Q.getCoordinateGrid = function() {
            return Le
        ...
        var K, ee, ne, re, oe, ie, se, de, he, ge, pe, me, ye, be, we, Ce, Me, Te, Ee, Se, xe, ke, He, Fe, Re, Ne, ze, We, Ae, Oe, Le, _e, Ye, qe, Be, Pe, je, Ie, Xe, Je, Ve, Ue, Ze = Q.opt,
            Ge = Q.trigger,
            $e = Q.renderOverlay,
            Qe = Q.clearOverlays,
        ...
        }), _e = new fe(Le), Ye = new ve(function(t) {
            return ie.eq(t)
        }), qe = new ve(function(t) {
            return se.eq(t)
        })
    }
    ...
    function te() {
        ...
        function a(e) {
            var n, r, a, s, l, c, f, v = P(),
                ...
                m = [];
            for (r = 0; v > r; r++)
                for (n = Y(0, r), u(n, h), a = ee(o(e, p, n, u(d(n), g - h))), ne(a), s = 0; s < a.length; s++)
                    for (l = a[s], c = 0; c < l.length; c++) f = l[c], f.col = r, f.level = s, m.push(f);
            return m
        }
        ...
        function s(n, r) {
            var a, o, i, s, l, u, d, v, h, g, p, m, D, w, C, M, E, S, k, H = n.length,
                N = "",
                z = F();
        ...
        function c(t, e) {
            ...
            return D(t) && o.push("fc-event-draggable"), e.isStart && o.push("fc-event-start"), e.isEnd && o.push("fc-event-end"), o = o.concat(t.className), t.source && (o = o.concat(t.source.className || [])), n += r ? "a href='" + q(t.url) + "'" : "div", n += " class='" + o.join(" ") + "' style='position:absolute;top:" + e.top + "px;left:" + e.left + "px;" + a + "'><div class='fc-event-inner'><div class='fc-event-time'>" + q(se(t.start, t.end, y("timeFormat"))) + "</div><div class='fc-event-title'>" + q(t.title || "") + "</div></div><div class='fc-event-bg'></div>", e.isEnd && w(t) && (n += "<div class='ui-resizable-handle ui-resizable-s'>=</div>"), n += "</" + (r ? "a" : "div") + ">"
        }

        function f(t, e, n) {
            var r = e.find("div.fc-event-time");
            D(t) && g(t, e, r), n.isEnd && w(t) && p(t, e, r), E(t, e)
        }
        ...
        function g(t, e, n) {
            ...
            var o, i, s, c, f, v, g, p, D, w, M, T = m.getCoordinateGrid(),
                E = P(),
                S = I(),
                x = X(),
                k = J();
            e.draggable({
                ...
                revertDuration: y("dragRevertDuration"),
                start: function(n, r) {
                    b("eventDragStart", e, t, n, r), G(t, e), T.build(), o = e.position(), i = T.cell(n.pageX, n.pageY), s = c = !0, f = v = O(i), g = p = 0, D = 0, w = M = 0
                },
                drag: function(t, n) {
                    var a = T.cell(t.pageX, t.pageY);
                    if (s = !!a) {
                        if (f = O(a), g = Math.round((n.position.left - o.left) / S), g != p) {
                            var l = Y(0, i.col),
                                u = i.col + g;
                            u = Math.max(0, u), u = Math.min(E - 1, u);
                            var d = Y(0, u);
                            D = h(d, l)
                        }
    ...
    function ne(t) {
        ...
        for (e = t.length - 1; e > 0; e--)
            for (a = t[e], n = 0; n < a.length; n++)
                for (o = a[n], r = 0; r < t[e - 1].length; r++) i = t[e - 1][r], re(o, i) && (i.forward = Math.max(i.forward || 0, (o.forward || 0) + 1))
    }
    ...
    function ae(n, r, a) {
        function o(e, n) {
            var r = Z[e];
            return t.isPlainObject(r) ? Y(r, n || a) : r
        }
        ...
        function y(t, e) {
            e.click(function(n) {
                return e.hasClass("ui-draggable-dragging") || e.hasClass("ui-resizable-resizing") ? void 0 : i("eventClick", this, t, n)
            }).hover(function(e) {
        ...
        function C(t, e, n, r, a, o, s) {
            var l = e.allDay,
                c = e._id;
            T(J[c], n, r, a), i("eventDrop", t, e, n, r, a, function() {
                T(J[c], -n, -r, l), I(c)
            }, o, s), I(c)
        }
        ...
        function M(t, e, n, r, a, o) {
            var s = e._id;
            E(J[s], n, r), i("eventResize", t, e, n, r, function() {
                E(J[s], -n, -r), I(s)
            }, a, o), I(s)
        }
        ...
        function _(t, e) {
            return q(t, e) || t.event.start - e.event.start || (t.event.title || "").localeCompare(e.event.title)
        }
    ...
    function oe() {
        ...
        function o(t) {
            for (var e = t.start, n = C(t), r = ee(e, n), a = 0; a < r.length; a++) r[a].event = t;
            return r
        }

        function i(t) {
            for (var e = S("isRTL"), n = 0; n < t.length; n++) {
                var r = t[n],
        ...
        function s(t) {
            for (var e = "", n = 0; n < t.length; n++) e += c(t[n]);
            return e
        }
        ...
        function c(t) {
            ...
            var i = j(r, S);
            return e += a ? "<a href='" + q(a) + "'" : "<div", e += " class='" + o.join(" ") + "' style='position:absolute;left:" + t.left + "px;" + i + "'><div  class='fc-event-inner'>", !r.allDay && t.isStart && (e += "<span class='fc-event-time'>" + q(G(r.start, r.end, S("timeFormat"))) + "</span>"), e += "<span class='fc-event-title'>" + q(r.title || "") + "</span></div>", t.isEnd && F(r) && (e += "<div class='ui-resizable-handle ui-resizable-" + (n ? "w" : "e") + "'>&nbsp;&nbsp;&nbsp;</div>"), e += "</" + (a ? "a" : "div") + ">"
        }
        ...
        function f(t, e) {
            var n = v(t),
                ...
                a = [];
            if (e)
                for (var o = 0; o < r.length; o++) r[o].height(n[o]);
            for (var o = 0; o < r.length; o++) a.push(r[o].position().top);
            se(t, function(t, e) {
        ...
        function v(t) {
            for (var e = Y(), n = P(), r = [], a = g(t), o = 0; e > o; o++) {
                for (var i = a[o], s = [], l = 0; n > l; l++) s.push(0);
                for (var c = 0; c < i.length; c++) {
                    var u = i[c];
                    u.top = L(s.slice(u.leftCol, u.rightCol + 1));
                    for (var l = u.leftCol; l <= u.rightCol; l++) s[l] = u.top + u.outerHeight
                }
                r.push(L(s))
            }
            return r
        ...
        function g(t) {
            var e, n, r, a = Y(),
                o = [];
            for (e = 0; e < t.length; e++) n = t[e], r = n.row, n.element && (o[r] ? o[r].push(n) : o[r] = [n]);
            for (r = 0; a > r; r++) o[r] = p(o[r] || []);
            return o
        }

        function p(t) {
            for (var e = [], n = m(t), r = 0; r < n.length; r++) e.push.apply(e, n[r]);
            return e
        }
        ...
        function m(t) {
            t.sort(ne);
            for (var e = [], n = 0; n < t.length; n++) {
                for (var r = t[n], a = 0; a < e.length && ie(r, e[a]); a++);
        ...
        function D(t, e, n) {
            H(t) && E.draggableDayEvent(t, e, n), n.isEnd && F(t) && E.resizableDayEvent(t, e, n), z(t, e)
        }
        ...
        function M(e, r, a) {
            ...
            B(r), r.mousedown(function(t) {
                ...
                function s(n) {
                    k("eventResizeStop", this, e, n), t("body").css("cursor", ""), d.stop(), Q(), u && _(this, e, u, 0, n), setTimeout(function() {
                        c = !1
                    }, 0)
                }
                if (1 == o.which) {
                    ...
                    var u, f, d = te(),
                        ...
                        h = t.extend({}, e),
                        g = ce(le(e.start));
                    K(), t("body").css("cursor", i + "-resize").one("mouseup", s), k("eventResizeStart", this, e, o), d.start(function(r, o) {
                        if (r) {
                            var s = ae(o),
                                c = ae(r);
                            if (c = Math.max(c, g), u = oe(c) - oe(s)) {
                                h.end = l(R(e), u, !0);
                                var d = f;
                                f = n(h, a.row, v), f = t(f), f.find("*").css("cursor", i + "-resize"), d && d.remove(), A(e)
                            } else f && (W(e), f.remove(), f = null);
                            Q(), $(e.start, l(C(e), u))
                        }
                    }, o)
                }
        ...
        var E = this;
        E.renderDayEvents = e, E.draggableDayEvent = w, E.resizableDayEvent = M;
        var S = E.opt,
            k = E.trigger,
            H = E.isEventDraggable,
            F = E.isEventResizable,
            R = E.eventEnd,
            N = E.reportEventElement,
            z = E.eventElementHandlers,
            W = E.showEvents,
            A = E.hideEvents,
            O = E.eventDrop,
            _ = E.eventResize,
            Y = E.getRowCnt,
            P = E.getColCnt,
            I = (E.getColWidth, E.allDayRow),
            X = E.colLeft,
            J = E.colRight,
            V = E.colContentLeft,
            U = E.colContentRight,
            Z = (E.dateToCell, E.getDaySegmentContainer),
            G = E.calendar.formatDates,
            $ = E.renderDayOverlay,
            Q = E.clearOverlays,
            K = E.clearSelection,
            te = E.getHoverListener,
            ee = E.rangeToSegments,
            ne = E.segmentCompare,
            re = E.cellToDate,
            ae = E.cellToCellOffset,
            oe = E.cellOffsetToDayOffset,
            le = E.dateToDayOffset,
            ce = E.dayOffsetToCellOffset
    }
    ...
    var he = {
            ...
            buttonText: {
                prev: "<span class='fc-text-arrow'><i class='fa fa-angle-left'></i></span>",
                next: "<span class='fc-text-arrow'><i class='fa fa-angle-right'></i></span>",
                prevYear: "<span class='fc-text-arrow'><i class='fa fa-angle-double-left '></i></span>",
                nextYear: "<span class='fc-text-arrow'><i class='fa fa-angle-double-right '></i></span>",
                today: "Today",
                month: "Month",
                week: "Week",
                day: "Day"
    ...
    pe.dateFormatters = Te, pe.applyAll = I, me.month = J, me.basicWeek = V, me.basicDay = U, n({
        weekMode: "fixed"
