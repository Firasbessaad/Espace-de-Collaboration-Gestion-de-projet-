var FirepadUserList = (function() {
  function FirepadUserList(ref, place, userId, displayName) {
    ...
    this.displayName_ = displayName || 'firas' ;
  ...
  FirepadUserList.prototype.makeUserEntryForSelf_ = function() {
    ...
    var nameInput = elt('input', null, { type: 'text', 'class': 'firepad-userlist-name-input', value: 'firas'} );
    nameInput.value = this.displayName_;

    var nameHint = elt('div', 'firas', { 'class': 'firepad-userlist-name-hint'} );
