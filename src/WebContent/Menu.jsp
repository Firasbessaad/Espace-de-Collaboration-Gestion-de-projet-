            ...
            <aside id="sidebar">
               ...
               <form action="Menu" method="post">
                <ul class="list-unstyled side-menu">
                    ...
                    <br><li>
                        <a>
                            <img src="./img/forum.png"><span class="menu-item"><input type="submit" class="btn btn-sm" value="Forum" name="forum"></span>
                       </a>
                    </li>                   
                    <br><li> 
                        <a>
                    ...
                    <br><li>
                        <a> 
                            <img src="./img/calendrier.png"><span class="menu-item"><input type="submit" class="btn btn-sm" value="Calendrier" name="calendrier"></span>
                       </a> 
                    </li>
